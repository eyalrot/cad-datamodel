...
class TestRectangleCreation:
    ...
    def test_metadata_copy(self):
        ...
        rect = Rectangle(
            ...
            layer_id="layer1", metadata=metadata
        )
...
class TestRectangleValidation:
    ...
    def test_negative_corner_radius_raises_error(self):
        ...
        with pytest.raises(ShapeValidationError) as excinfo:
            Rectangle(
                x=0, y=0, width=100, height=50,
                corner_radius=-5, layer_id="layer1"
            )
    ...
    def test_corner_radius_exceeds_limit(self):
        ...
        with pytest.raises(ShapeValidationError) as excinfo:
            Rectangle(
                x=0, y=0, width=100, height=50,
                corner_radius=30, layer_id="layer1"  # Max should be 25
            )
    ...
    def test_corner_radius_at_limit(self):
        ...
        rect = Rectangle(
            x=0, y=0, width=100, height=50,
            corner_radius=25, layer_id="layer1"
        )
...
class TestRectangleBounds:
    ...
    def test_bounds_with_translation(self):
        ...
        rect = Rectangle(
            ...
            layer_id="layer1", transform=transform
        )
        bounds = rect.get_bounds()
...
class TestRectangleTransform:
    ...
    def test_apply_transform_preserves_properties(self):
        ...
        rect1 = Rectangle(
            x=10, y=20, width=100, height=50,
            corner_radius=5, layer_id="layer1",
            group_id="group1", visible=False, locked=True,
...
class TestRectangleSerialization:
    ...
    def test_to_dict_complete(self):
        ...
        rect = Rectangle(
            ...
            corner_radius=15, layer_id="layer2",
            group_id="group1", visible=False, locked=True,
            style=style, transform=transform, metadata=metadata
        )
    ...
    def test_roundtrip_serialization(self):
        ...
        rect1 = Rectangle(
            x=15.5, y=25.5, width=150.5, height=75.5,
            corner_radius=12.5, layer_id="layer1",
            group_id="group1", visible=False, locked=True,
            style=style, transform=transform, metadata=metadata
        )
...
class TestRectangleRepresentation:
    ...
    def test_repr(self):
        ...
        rect = Rectangle(
            x=10.5, y=20.5, width=100.5, height=50.5,
            corner_radius=5.5, layer_id="layer1"
        )
