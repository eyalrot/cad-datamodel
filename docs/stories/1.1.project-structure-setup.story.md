...
- [x] Create base directory structure (AC: 1)
  - [x] Create all directories under cad_datamodel/
...
- [x] Create initial package files (AC: 5)
  - [x] Create cad_datamodel/__init__.py with version
...
- CONTRIBUTING.md
- CHANGELOG.md
- cad_datamodel/__init__.py
- cad_datamodel/core/__init__.py
- cad_datamodel/shapes/__init__.py
- cad_datamodel/layers/__init__.py
- cad_datamodel/styles/__init__.py
- cad_datamodel/transform/__init__.py
- cad_datamodel/geometry/__init__.py
- cad_datamodel/persistence/__init__.py
- tests/__init__.py
...
- **File**: cad_datamodel/core/base.py and cad_datamodel/core/types.py
...
- **File**: cad_datamodel/core/types.py
...
- **File**: cad_datamodel/core/constants.py
